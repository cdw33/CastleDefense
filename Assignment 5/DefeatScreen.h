...
public:
	...
	void draw(const Data &data){
		...
		graphics.drawText("Enemies Killed: ", 30, 160, 240, 255, 255, 255);	graphics.drawText(to_string(data.killedTotal).c_str(), 30, 320, 240, 255, 255, 255);
		graphics.drawText("Points Earned: ", 30, 160, 270, 255, 255, 255);	graphics.drawText(to_string(data.points).c_str(), 30, 320, 270, 255, 255, 255);
		graphics.drawText("Cash Earned: ", 30, 160, 300, 255, 255, 255);	graphics.drawText(to_string(data.moneyTotal).c_str(), 30, 320, 300, 255, 255, 255);
