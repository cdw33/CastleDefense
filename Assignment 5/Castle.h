	...
	public:	
		...
		Castle() {
			defInfo = new defData[8];
				...
				setVal(defInfo[4], "Images/Castle_Defense/steel.bmp", 120, 60);
				setVal(defInfo[5], "Images/Castle_Defense/mithril.bmp", 160, 80);
				setVal(defInfo[6], "Images/Castle_Defense/diamond.bmp", 250, 100);
				setVal(defInfo[7], "Images/Castle_Defense/lonsdaleite.bmp", 350, 125);

			offInfo = new offData[9];
				setVal(offInfo[0], "Images/Castle_Offense/nothing.bmp", 0, 0);
				setVal(offInfo[1], "Images/Castle_Offense/barbed_wire.bmp", 5, 10);
				setVal(offInfo[2], "Images/Castle_Offense/stakes.bmp", 10, 20);
				setVal(offInfo[3], "Images/Castle_Offense/spike.bmp", 20, 30);
				setVal(offInfo[4], "Images/Castle_Offense/poison_spike.bmp", 30, 40);
				setVal(offInfo[5], "Images/Castle_Offense/lava.bmp", 40, 50);
				setVal(offInfo[6], "Images/Castle_Offense/lava_poison_spike.bmp", 60, 60);
				setVal(offInfo[7], "Images/Castle_Offense/electric_1.bmp", 80, 70);  /* Part 1 - use this index for values*/
